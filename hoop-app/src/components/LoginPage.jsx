...
const LoginPage = ({ onLogin, isLoading }) => {
  ...
  return (
    <div style={{ position:'fixed', inset:0, background:'#020B18', overflow:'hidden', fontFamily:"'Inter',system-ui,sans-serif" }}>
      ...
      {/* ── LOGIN ── */}
      {phase === 'login' && (
        <div style={{ position:'relative', zIndex:10, height:'100%', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:'24px 20px', animation:'fadeUp 0.5s ease' }}>
